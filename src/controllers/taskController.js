...
const updateTask = (req, res) => {
  ...
  Task.findById(id, (err, task) => {
    ...
    // Atualizar apenas os campos fornecidos no corpo da requisição e não vazios
    const updatedTask = {
      title: title !== undefined && title !== '' ? title : task.title,
      description: description !== undefined && description !== '' ? description : task.description,
      completed: completed !== undefined && completed !== '' ? completed : task.completed
    };
